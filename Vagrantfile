...
###########################Maquinas base Centos#################################


config.vm.define "master" do |master|
 master.vm.box = "geerlingguy/centos7"
 master.vm.network "public_network" ,ip: "192.168.2.110"
...
(1..2).each do |i|
	...
	node.vm.box = "geerlingguy/centos7" 
        node.vm.network "public_network" ,ip: "192.168.2.15#{i}"
